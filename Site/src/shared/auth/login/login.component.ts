...
import { AuthService, AuthSession, LoginPayload, UserRole } from '@shared/auth/auth.service';
...
export class LoginComponent implements OnDestroy {
  ...
  private readonly loginConfig = inject(LOGIN_CONFIG);
  ...
  readonly allowSignup = this.loginConfig.allowSignup;
  ...
  constructor(
    ...
    this.authService.session$
      ...
      .subscribe(() => {
        void this.router.navigate([this.loginConfig.postLoginRedirect]);
      });
  }
  ...
  goToSignup(): void {
    void this.router.navigate([this.loginConfig.signupRoute]);
  }
